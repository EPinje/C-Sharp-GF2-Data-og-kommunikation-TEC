...
namespace _31___Tabeltæller
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int talMultiplikation = 1;/*variabel til løkken oprettes med værdien 1*/ talMultiplikation <= 20;/*løkken skal gentage sig selv så længe variablen er under eller lig med 20, her betyder det at 33 tabllen forsætter til 20 * 33*/ talMultiplikation++)/*variablen stiger med 1 hver gang løkken er blevet kørt igennem*/
            {
                Console.WriteLine($"{talMultiplikation, 2} * {tabel33, 2} = {talMultiplikation * tabel33, 3}"); //løkkens variabels værdi ganges med tabellens værdi, på den opnås det rigtige tal til leddet i tabellen.
